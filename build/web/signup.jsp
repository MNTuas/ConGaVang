                ...
                <div class="login">
                    <div class="login-container">
                        <h2>
                            ...
                            <a href=""><span style="border-bottom: 2px solid white;">Sign in</span></a>
                        </h2>
                        <form action="./signup" method="post">
                            <div class="form-group">
                                <label for="username">Username</label><br>
                                <input type="text" id="email" placeholder=" Name" name="username">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="email" placeholder=" Phone" name="phone">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="password" placeholder=" Re-Password" name="repassword">
                            </div>
                            <div class="form-group">
                                <p class="text-danger">${mess}</p>

                                <input class="login-back"  type="submit" value="Sign in">
